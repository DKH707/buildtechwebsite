  ...
  return (
    <>
      <Helmet>
        {/* Primary Meta Tags */}
        <title>
          Buildtech Systems | Web Apps, Mobile Apps & Tech Consulting in Texas
        </title>
        <meta
          name="title"
          content="Buildtech Systems | Web Apps, Mobile Apps & Tech Consulting in Texas"
        />
        <meta
          name="description"
          content="Professional web development, mobile app creation, and technology consulting services in Texas. Expert custom solutions for your business. Let's build tech, together!"
        />
        <meta
          name="keywords"
          content="web development, mobile apps, tech consulting, Texas web developer, custom software, app development, Crowley TX"
        />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.buildtechsys.com/" />
        <meta
          property="og:title"
          content="Buildtech Systems | Web Apps, Mobile Apps & Tech Consulting"
        />
        <meta
          property="og:description"
          content="Professional web development, mobile app creation, and technology consulting services in Texas. Let's work together!"
        />

        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://www.buildtechsys.com/" />
        <meta
        ...
        <meta
          ...
          content="Professional web development, mobile app creation, and technology consulting services in Texas."
        />

        {/* Canonical URL */}
        <link rel="canonical" href="https://www.buildtechsys.com/" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Organization",
            name: "Buildtech Systems",
            url: "https://www.buildtechsys.com",
            logo: "https://www.buildtechsys.com/icon.png",
            description: "Web Apps | Mobile Apps | Tech Consulting",
            founder: {
              "@type": "Person",
              name: "Derek",
            },
            address: {
              "@type": "PostalAddress",
              streetAddress: "3908 Williamson Road Suite 110",
              addressLocality: "Crowley",
              addressRegion: "TX",
              postalCode: "76036",
              addressCountry: "US",
            },
            sameAs: ["https://www.linkedin.com/company/buildtechsys"],
            contactPoint: {
              "@type": "ContactPoint",
              contactType: "Customer Service",
              url: "https://www.buildtechsys.com/contact",
            },
          })}
        </script>
      </Helmet>
