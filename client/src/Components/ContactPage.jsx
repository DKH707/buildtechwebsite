        ...
        <div className="isolate bg-bground px-6 py-20 sm:py-20">
          ...
          >
            <div
              ...
              className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-primary to-gold-dark opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
            />
          </div>
          <div className="mx-auto px-6 lg:max-w-7xl lg:px-8">
            ...
            <p className="mt-2 text-left text-lg/8 text-gray-300">
